...
# Title: FM Receiver
# Generated: Tue Nov 27 11:07:30 2018
##################################################
...
class fm_receiver(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self._tuner_chooser = forms.radio_buttons(
        	...
        	choices=[88.1e6, 97.9e6, 102.3e6],
        	labels=["WYPR", "WIYY", "W272BJ"],
    ...
    def set_tuner(self, tuner):
        ...
        self.wxgui_fftsink2_1.set_baseband_freq(self.tuner)
    ...
    def set_down_rate(self, down_rate):
        ...
        self.wxgui_fftsink2_0.set_sample_rate(self.down_rate)
